        ...
        "dotnetnuke": {
            ...
            "packages": [{
                "package": [{
                    ...
                    "dependencies": [
                        config.dnn.module.dependencies || oldManifest.dotnetnuke.packages[0].package[0].dependencies
                    ],
                    "azureCompatible": [
...
// todo: finish this
    // manifest.dotnetnuke.packages[0].package[0].dependencies.push({
    //     "dependency": [{
    //         "_": "Dnn.PersonaBar.UI",
    //         "$": {
    //             "type": "ManagedPackage",
